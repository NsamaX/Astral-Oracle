...
You can experience the application live at: [Astral Oracle](https://astral-oracle.vercel.app/)
...
3.  Create a `.env` file in the root directory and add your Groq API key and MongoDB URI:
